...
public readonly struct FirmwareInfo
{
    ...
    public bool IsValid
    {
        get
        {
            return _raw.Length >= 60 && _raw[0] == 0x20;
        }
    }
    ...
    public string BuildDate
    {
        get
        {
            return IsValid ? GetAsciiString(1, 11) : string.Empty;
        }
    }
    ...
    public string BuildTime
    {
        get
        {
            return IsValid ? GetAsciiString(12, 8) : string.Empty;
        }
    }
    ...
    public ushort FirmwareType
    {
        get
        {
            return IsValid ? GetUInt16(20) : (ushort)0;
        }
    }
    ...
    public ushort SoftwareSeries
    {
        get
        {
            return IsValid ? GetUInt16(22) : (ushort)0;
        }
    }
    ...
    public ushort ModelRevision
    {
        get
        {
            return (ushort)(HardwareInfo & 0xFFFF);
        }
    }
    ...
    /// </summary>
    public DualSenseHardwareGeneration HardwareGeneration
    {
        get
        {
            return IsValid
    ...
    public bool HasFullPlayerLedSupport
    {
        get
        {
            return HardwareGeneration is DualSenseHardwareGeneration.Generation2 or DualSenseHardwareGeneration.Generation3;
        }
    }
    ...
    public string MainFirmwareVersion
    {
        get
        {
            return IsValid ? FormatVersion(GetUInt32(28)) : string.Empty;
        }
    }
    ...
    public string UpdateVersion
    {
        get
        {
            return IsValid ? FormatUpdateVersion(GetUInt16(44)) : string.Empty;
        }
    }
    ...
    /// </summary>
    public ushort UpdateVersionValue
    {
        get
        {
            return IsValid ? GetUInt16(44) : (ushort)0;
        }
    }
    ...
    public string SblFirmwareVersion
    {
        get
        {
            return IsValid ? FormatVersion(GetUInt32(48)) : string.Empty;
        }
    }
    ...
    public string DspFirmwareVersion
    {
        get
        {
            return IsValid ? FormatDspVersion(GetUInt32(52)) : string.Empty;
        }
    }
    ...
    public string McuSpiderDspFirmwareVersion
    {
        get
        {
            return IsValid ? FormatVersion(GetUInt32(56)) : string.Empty;
        }
    }
