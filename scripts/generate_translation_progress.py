...
Examples:
    ...
    python generate_translation_progress.py --directory "path\to\source\DualSenseClient.GUI\Resources\Language"
...
def main():
    ...
    if args.directory:
        ...
        possible_dirs = [
            script_dir.parent / "source" / "DualSenseClient.GUI" / "Resources" / "Language",
